        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row">
                        @foreach ($allSearchedProducts->getData()->products as $item)
                        {{-- {{dd($allSearchedProducts)}} --}}
                            <div class="col-md-4">
                                <div class="card mb-4 product-wap rounded-0">
                                    ...
                                    <div class="card-body" style="height: 175px; text-align:center">
                                        ...
                                        <ul class="w-100 list-unstyled d-flex justify-content-around mb-0">
                                            <li class="mb-0 mt-2"><a class="btn btn-success text-white" href="shop-single.html"><i
